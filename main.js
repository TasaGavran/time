...
function renderMenuCards(container, items, statusEl) {
  ...
  list.forEach((item) => {
    ...
    card.className =
      "rounded-2xl border border-espresso/10 bg-white/70 p-4 shadow-md shadow-black/10 backdrop-blur dark:border-white/10 dark:bg-espresso/90";
    card.innerHTML = `
